...
from domain.value_objects.prediction import IPrediction, Prediction
from domain.value_objects.population import TotalPopulation
from domain.value_objects.income import MedianIncome
from domain.value_objects.radar import Radar
from domain.value_objects.operation import Operation
from domain.services.generative_ai import IGenerativeAIService

logger = Logger(__name__)
class PredictionService:
    def __init__(self, prediction_repository: IPredictionRepository, generative_ai_service: IGenerativeAIService):
        self.prediction_repository = prediction_repository
        self.generative_ai_service = generative_ai_service
    ...
    def get_ai_insight(self, id: int, score: float, report: str) -> str:
        ...
        ai_insight = self.generative_ai_service.invoke(user_message=user_message)
